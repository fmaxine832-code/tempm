    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: "var(--bg)" }}>
        <div className="card max-w-sm w-full mx-4">
          <h1 className="text-lg font-semibold mb-4" style={{ color: "var(--primary)" }}>🔒 账号管理</h1>
          <input
            type="password"
            placeholder="管理员密码"
            value={tokenInput}
    ...
    <div className="min-h-screen" style={{ background: "var(--bg)" }}>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold" style={{ color: "var(--primary)" }}>🗂️ 账号管理</h1>
          <a href="/" className="text-sm text-gray-500 hover:text-gray-700">← 返回首页</a>
        </div>

        <p className="text-sm text-gray-500 mb-5">
          每当临时邮箱收到邮件，系统会自动记录该地址并生成一个随机密码。
        </p>
